...
class GraphFloat:
    """
    Reimplementation from scratch of the maxflow algorithm.
    This class can be used exactly as the PyMaxFlow.GraphFloat class.
    It is just slower, as it does not rely on C code. 
    """
    def __init__(self):
